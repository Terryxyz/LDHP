...
def update_points(num):
    ...
    if iteration < len(object_pose_trajectory):
        ...
        current_F1, current_F2, current_gripper_profile = bottom_layer.gripper_profile(
            gripper_pose_trajectory[iteration]
        )
        ...
        gripper_frame1.set_data(
            [j[0] for j in F1_F1_F2_perp1], [j[1] for j in F1_F1_F2_perp1]
        )
        gripper_frame2.set_data(
            [j[0] for j in F2_F1_F2_perp1], [j[1] for j in F2_F1_F2_perp1]
        )
        gripper_frame3.set_data(
            [j[0] for j in F1_perp1_out], [j[1] for j in F1_perp1_out]
        )
        gripper_frame4.set_data(
            [j[0] for j in F2_perp1_out], [j[1] for j in F2_perp1_out]
        )
...
if __name__ == "__main__":
    ...
    ini_F1, ini_F2, ini_gripper_profile = bottom_layer.gripper_profile(
    ...
    (gripper_frame1,) = ax.plot(
        [j[0] for j in F1_F1_F2_perp1],
        [j[1] for j in F1_F1_F2_perp1],
        "#54C8F4",
        zorder=4,
        lw=2,
    )
    (gripper_frame2,) = ax.plot(
        [j[0] for j in F2_F1_F2_perp1],
        [j[1] for j in F2_F1_F2_perp1],
        "#54C8F4",
        zorder=4,
        lw=2,
    )
    (gripper_frame3,) = ax.plot(
        [j[0] for j in F1_perp1_out],
        [j[1] for j in F1_perp1_out],
        "#54C8F4",
        zorder=4,
        lw=2,
    )
    (gripper_frame4,) = ax.plot(
        [j[0] for j in F2_perp1_out],
        [j[1] for j in F2_perp1_out],
        "#54C8F4",
        zorder=4,
        lw=2,
    )
